...
jQuery(document).ready(function ($) {
    ...
    const setUsersTable = ()=>{
            ...
            $('#usersTable').DataTable({
                ...
                ajax: {
                    url: `${backendURL}/users?confirmed`,
                    dataSrc: ""
                },
                columns: [
                    {"data": (e)=>{
    ...
    const setSuspectsTable = ()=>{
        ...
        $('#sespectsTable').DataTable().clear().destroy();
        $('#sespectsTable').DataTable({
            lengthMenu: [[10, 25, 50, -1], [10, 25, 50, "All"]],
            'columnDefs': [
                {
                    "targets": -1,
            ...
            ajax: {
                url: `${backendURL}/users?suspect&dates=${days.join()}`,
                dataSrc: ""
            },
            columns: [
                {"data": "nid", "width": "30%"},
        ...
        $('#sespectsTable tbody').on('click', '.visitsBtn', setUserVisitsModal);
        $('#sespectsTable tbody').on('click', '.notifBtn', setSendNotifModal);
        $('#sespectsTable tbody').on('click', '.meetsBtn', setMeetsModal);
    }
